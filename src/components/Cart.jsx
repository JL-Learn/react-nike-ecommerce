      ...
      >
        ...
        >
          ...
          {cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-white w-full px-5 py-1 grid items-center">
              <div className="flex items-center justify-between">
                <h1 className="text-base font-semibold uppercase">Total</h1>
                <h1 className="text-sm rounded bg-theme-cart text-slate-100 px-1 py-0.5">R${totalAmount}</h1>
              </div>
              <div className="grid items-center gap-2">
                <p className="text-sm font-medium text-center">Impostos e frete serão calculados no envio</p>
